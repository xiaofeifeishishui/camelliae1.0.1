//
//  CMLOtherServeDetailVC.m
//  camelliae1.0.1
//
//  Created by 张越 on 16/5/10.
...
@interface CMLOtherServeDetailVC ()<NavigationBarDelegate>

@end

@implementation CMLOtherServeDetailVC
...
- (void)viewDidLoad {
    ...
    NSString *body = [NSString stringWithFormat: @"reqTime=%@&skey=%@&clientId=%@&hashToken=%@",reqTime,skey,userID,hashToken];
