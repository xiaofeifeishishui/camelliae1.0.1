...
@interface CMLIntroduceUpgradeVC () <NavigationBarDelegate>

@property (nonatomic,strong) NSArray *dataArray;

@end

@implementation CMLIntroduceUpgradeVC

- (void)viewDidLoad{

    [super viewDidLoad];
    self.view.backgroundColor = [UIColor blackColor];
    self.navBar.titleContent = @"等级";
...
- (void) loadViews{
    ...
    startLabel.font = KSystemFontSize12;
    ...
    for (int i = 0; i < 5; i++) {
        ...
        CMLFontLayout *fontLayout = [[CMLFontLayout alloc] initWithFrame:CGRectMake(LineStartPointX*Proportion,
                                                                                    ...
                                                                                    0)];
        CGFloat textHeight = [fontLayout setFontLayoutWith:self.dataArray[i]];
